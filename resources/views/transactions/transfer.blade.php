...
<div class="relative overflow-x-auto flex justify-center h-screen">
    <div class="w-3/4 h-3/4 bg-slate-100 justify-center flex">
        <div class="bg-white w-1/2 h-5/6 mt-5 px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-gray-600">
            Transfer Money
            <hr class="mt-2">
            @if (session('error'))
            ...
            <form action="" method="post">
                ...
                <div class="mb-6">
                    <label for="email"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600 mt-2">Email
                        address</label>
                    <input type="email" name="receiver_email" value="{{ old('receiver_email') }}" id="base-input"
